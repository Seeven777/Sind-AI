...
class SwarmOrchestrator:
    ...
    def __init__(self, models, registry, blackboard, apprenticeship=None, config=None):
        self.models = models
    ...
    def prepare(self, goal, base_context="", status=None):
        ...
        roles = self.registry.select(goal, max_roles=self.max_specialists)
    ...
    def solve(self, goal, base_context="", status=None):
        ...
        self.blackboard.finish(bundle["session_id"], "completed")
