...
Write-Host "Sind AI - Jarvis Personal GPT 1.9" -ForegroundColor Magenta
...
if (-not $source) { throw "O pacote baixado nao contem jarvis_desktop.py. Confirme se a branch '$Branch' já recebeu a versão 1.9." }
...
try {
  $headers = @{
    "User-Agent" = "SindAI-Jarvis-Installer/1.9"
